...
//        [imageView addGestureRecognizer:doubleTap];
        ...
        imageView.singleTapGestureBlock = ^(){
            [weakSelf photoClick:singleTap];
        };
...
- (void)setupImageOfImageViewForIndex:(NSInteger)index
{
    ...
    if ([self highQualityImageURLForIndex:index]) {
        ...
        [imageView setImageWithURL:[self highQualityImageURLForIndex:index] placeholderImage: [self placeholderImageForIndex:index] completed:nil];
    } else {
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    UIView *sourceView = _currentView;
