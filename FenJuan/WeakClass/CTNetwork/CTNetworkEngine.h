...
#define CT_API_DEVELOPER_BASE_URL @"http://xxx.fenhuishenghuo.com"//@"http://test.youquan8888888.com"//

#define CT_API_PRODUCTION_BASE_URL @"http://xxx.fenhuishenghuo.com"//
...
typedef NS_ENUM(NSInteger,CTNetCachesType){
    CTNetCachesNone,
    CTNetCachesJust,
    CTNetCachesAndNew,
};
