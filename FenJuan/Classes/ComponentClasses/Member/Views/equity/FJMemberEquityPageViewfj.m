...
@interface FJMemberEquityPageViewfj()<UIScrollViewDelegate>

@end

@implementation FJMemberEquityPageViewfj
{
...
- (void)setList:(NSArray *)list{
    ...
    for(int i = 0;i < _list.count;i ++){
        ...
        FjMfjemberEquityItemView *view = NSMainBundleClass(FjMfjemberEquityItemView.class);
        view.titleLabel.text = [titles safe_objectAtIndex:i];
        view.datas = [FJMemberRebateModelfj yy_modelsWithDatas:subList];
        view.tag = 100 + i;
