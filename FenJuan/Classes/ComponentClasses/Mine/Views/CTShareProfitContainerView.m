...
@interface CTShareProfitContainerView()<ReCarouselViewDataSoure,ReCarouselViewDelegate>
@property (nonatomic, strong)ReCarouselView *carouselView;
@property (nonatomic, assign) NSInteger currentIndex;
@property (nonatomic, copy) UIImage *currentImage;
@end
@implementation CTShareProfitContainerView
