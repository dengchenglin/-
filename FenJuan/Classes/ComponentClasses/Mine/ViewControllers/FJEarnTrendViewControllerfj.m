...
@interface FJEarnTrendViewControllerfj ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation FJEarnTrendViewControllerfj
...
- (void)request{
    [CTRequest fj_incomeTrendWithCallback:^(id data, CLRequest *request, CTNetError error) {
        if(!error){
            self.model = [FJEarnTrendModelfj yy_modelWithDictionary:data];
