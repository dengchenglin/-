...
@interface FJGoodSearchViewControllerfj ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation FJGoodSearchViewControllerfj
...
- (void)request{
    [super request];
    [CTRequest fj_searchHistoryWithCallback:^(id data, CLRequest *request, CTNetError error) {
        if(!error){
...
- (void)searchKeyword:(NSString *)keyword order:(NSString *)order{
    [CTRequest fj_goodsSearchWithKeyword:keyword page:self.pageIndex size:self.pageSize order:order callback:^(id data, CLRequest *request, CTNetError error) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    UIViewController *vc = [[CTModuleManager goodListService]fj_goodDetailViewControllerWithGoodViewModel:self.dataSources[indexPath.row]];
