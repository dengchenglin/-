...
@interface FJGoodResultViewControllerfj ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation FJGoodResultViewControllerfj
...
- (void)request{
    [CTRequest fj_goodsSearchWithKeyword:_keyword page:self.pageIndex size:self.pageSize order:GetGoodsOrderStr(self.sortView.currentType) callback:^(id data, CLRequest *request, CTNetError error) {
