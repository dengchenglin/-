...
@interface FJVideoShopPageControllerfj ()<LMSegmentedControlDelegate>
...
@implementation FJVideoShopPageControllerfj
...
- (void)reloadData:(id)data{
    ...
    for(int i = 0;i < self.cates.count;i ++){
        FJVideoShopListViewControllerfj *vc = [[FJVideoShopListViewControllerfj alloc]init];
