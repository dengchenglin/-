...
#import "FJVideoShopListViewControllerfj.h"
...
@interface FJVideoShopListViewControllerfj ()<CTVideoGoodListCellDelegate,JPVideoPlayerDelegate>
...
@implementation FJVideoShopListViewControllerfj
...
- (void)setUpUI{
    ...
    [self.tableView registerNibWithClass:FJVideoGoodListCellfj.class];
}
...
- (void)request{
    ...
    [CTRequest fj_videoBuyGoodsWithPage:self.pageIndex size:self.pageSize cateId:self.cateId order:GetGoodsOrderStr(self.sortView.currentType) callback:^(id data, CLRequest *request, CTNetError error) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    FJVideoGoodListCellfj *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(FJVideoGoodListCellfj.class)];
    cell.delegate = self;
...
- (void)didClickVideoWithIndexPath:(NSIndexPath *)indexPath{
    ...
    FJVideoGoodListCellfj *cell = [self.tableView cellForRowAtIndexPath:indexPath];
    ...
    NSArray <FJVideoGoodListCellfj *>*cells = [self.tableView visibleCells];
    for(FJVideoGoodListCellfj *cell in cells){
...
- (void)removeCurrentVideo{
    if(_currentIndexPath){
        FJVideoGoodListCellfj *cell = [self.tableView cellForRowAtIndexPath:_currentIndexPath];
        [cell stopPlay];
    }
}
